...
# User notes editing
MSG_NOTES_CREATE_PROMPT="📝 Do you want to create user notes for this backup? (Y/n): "
...
MSG_BACKUP_CANCELLED="⏹️ Backup cancelled by user"
MSG_BACKUP_CHECKING_STRUCTURE="🔍 Checking backup structure..."
MSG_BACKUP_CLEANUP_FAILED="⚠️ Warning: Backup cleanup failed"
MSG_BACKUP_CREATING_WORK_DIR="📁 Creating working directory..."
MSG_BACKUP_DIR_CREATE_FAILED="❌ Failed to create backup directory"
MSG_BACKUP_DISK_SPACE_OK="✅ Disk space check passed"
MSG_BACKUP_LOCATION="📍 Backup location: %s"
MSG_BACKUP_LOG_CREATED="📝 Backup log created successfully"
MSG_BACKUP_META_CREATED="📊 Backup metadata created successfully"
MSG_BACKUP_NO_DIRECTORY="❌ No directory specified for backup"
MSG_BACKUP_RECENT_LIST="📋 Recent backups:"
MSG_BACKUP_STORE_CREATE_FAILED="❌ Failed to create backup store"
MSG_BACKUP_STRUCTURE_READY="✅ Backup structure ready"
MSG_BACKUP_TARGET_VALID="✅ Backup target is valid"
MSG_BACKUP_VALIDATING_TARGET="🔍 Validating backup target..."
MSG_BACKUP_WORK_DIR="📁 Working directory: %s"
MSG_BACKUP_WORK_DIR_CREATED="📁 Working directory created successfully"
...
MSG_UNINSTALL_HEADER_TITLE="TARSYNC UNINSTALLER"
MSG_UNINSTALL_ITEMS_TO_REMOVE="⚠️  The following items will be removed:"
MSG_UNINSTALL_CONFIG_DIR="Configuration: %s"
MSG_UNINSTALL_USER_CONFIG="User settings: %s"
...
MSG_UNINSTALL_FAILED="❌ Uninstallation failed"
MSG_UNINSTALL_ISSUES_FOUND="⚠️  Some issues were found during removal:"
MSG_UNINSTALL_MANUAL_CLEANUP_NEEDED="🧹 Manual cleanup may be required"
MSG_UNINSTALL_RESTART_TERMINAL="🔄 Please restart your terminal or run: source ~/.bashrc"
