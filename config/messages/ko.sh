...
MSG_RESTORE_SELECT_BACKUP="복구할 백업을 선택하세요 (번호 또는 디렉토리 이름): "
MSG_RESTORE_BACKUP_NOT_FOUND="❌ 백업 번호 %s 에 해당하는 백업을 찾을 수 없습니다"
MSG_RESTORE_INVALID_BACKUP="❌ 선택된 백업이 유효하지 않거나 필수 파일이 없습니다: %s"
MSG_RESTORE_INVALID_TARGET="❌ 복구 대상 경로가 유효하지 않거나 쓰기 권한이 없습니다: %s"
MSG_RESTORE_MODE_SELECT="⚙️  복구 방식을 선택하세요"
MSG_RESTORE_BACKUP_INFO="  - 📦 백업: %s"
MSG_RESTORE_MODE_SAFE="1️⃣  안전 복구 (기본값)"
MSG_RESTORE_MODE_SAFE_DESC="    기존 파일은 그대로 두고, 백업된 내용만 추가하거나 덮어씁니다."
MSG_RESTORE_MODE_SAFE_RECOMMEND="    (일반적인 복구에 권장됩니다.)"
MSG_RESTORE_MODE_FULL="2️⃣  완전 동기화 (⚠️ 주의: 파일 삭제)"
MSG_RESTORE_MODE_FULL_DESC="    백업 시점과 완전히 동일한 상태로 만듭니다."
MSG_RESTORE_MODE_CANCEL="3️⃣  취소"
MSG_RESTORE_MODE_CANCEL_DESC="    복구 작업을 중단합니다."
MSG_RESTORE_INVALID_CHOICE="❌ 잘못된 선택입니다. 1, 2, 3 중에서 선택하세요."
MSG_RESTORE_EXTRACTING="📦 백업 파일 압축 해제 중..."
MSG_RESTORE_EXTRACT_FAILED="❌ 압축 해제에 실패했습니다."
MSG_RESTORE_EXTRACT_COMPLETE="✅ 압축 해제 완료."
MSG_RESTORE_LOG_SAVED="📜 복구 로그가 저장되었습니다: %s"
MSG_RESTORE_HISTORY_UPDATED="📊 복구 이력이 업데이트되었습니다: %s"
MSG_RESTORE_FULL_SYNC_WARNING="🔥 완전 동기화 모드로 실행합니다. (백업에 없는 파일은 삭제되지만 제외 경로는 보호됩니다)"
MSG_RESTORE_SYNC_START="🔄 파일 동기화 시작..."
MSG_RESTORE_SYNC_COMPLETE="📊 처리 완료: %s개 파일 동기화, 크기: %s, 효율: %sx"
...
MSG_INSTALL_BASH_COMPLETION_INSTALLED="bash-completion 패키지가 이미 설치되어 있습니다"
MSG_INSTALL_BASH_COMPLETION_ACTIVE="bash completion이 이미 활성화되어 있습니다"
MSG_INSTALL_BASH_COMPLETION_COMPLETE="bash-completion 시스템 설정이 완료되었습니다"
MSG_INSTALL_COMPLETION_TITLE="🚀 자동완성을 바로 사용하려면:"
MSG_INSTALL_CONTAINER_ENV_DETECTED="📦 컨테이너 환경이 감지되었습니다"
MSG_INSTALL_BASH_ENV_DETECTED="🐚 Bash 환경이 감지되었습니다"
MSG_INSTALL_ZSH_ENV_DETECTED="🐚 ZSH 환경이 감지되었습니다"
...
MSG_LIST_LOADING="📋 백업 목록 조회 중..."
MSG_LIST_NO_BACKUPS="⚠️  백업 파일이 없습니다."
MSG_LIST_BACKUP_NOT_FOUND_IDENTIFIER="❌ 백업 번호 %s에 해당하는 백업을 찾을 수 없습니다."
MSG_LIST_HEADER="📦 tarsync 백업 목록"
MSG_LIST_DIVIDER="===================="
MSG_LIST_STORAGE_TOTAL="🔳 전체 저장소: %sB"
MSG_LIST_PAGE_TOTAL="🔳 페이지 총합: %s"
MSG_LIST_PAGE_INFO="🔳 페이지 %d/%d (총 %d 개 백업)"
MSG_LIST_DELETE_CONFIRM="🗑️  백업 삭제 확인"
MSG_LIST_DELETE_TARGET="   대상: %s"
MSG_LIST_DELETE_PATH="   경로: %s"
MSG_LIST_DELETE_SIZE="   크기: %s"
MSG_LIST_DELETE_PROMPT="정말로 이 백업을 삭제하시겠습니까? [y/N]: "
MSG_LIST_DELETE_PROCESSING="🗑️  백업 삭제 중..."
MSG_LIST_DELETE_SUCCESS="✅ 백업이 성공적으로 삭제되었습니다: %s"
MSG_LIST_DELETE_ERROR="❌ 백업 삭제 중 오류가 발생했습니다."
MSG_LIST_DELETE_CANCELLED="❌ 백업 삭제가 취소되었습니다."
MSG_LIST_DETAILS_HEADER="📋 백업 상세 정보"
MSG_LIST_DETAILS_DIVIDER="=================="
MSG_LIST_DETAILS_NAME="📂 백업 이름: %s"
MSG_LIST_DETAILS_PATH="📁 백업 경로: %s"
MSG_LIST_DETAILS_SIZE="📦 백업 크기: %s"
MSG_LIST_DETAILS_STATUS="🔍 백업 상태: %s"
MSG_LIST_DETAILS_META_HEADER="📄 메타데이터 정보:"
MSG_LIST_DETAILS_META_SOURCE_SIZE="   원본 크기: %s"
MSG_LIST_DETAILS_META_CREATED="   생성 날짜: %s"
MSG_LIST_DETAILS_META_EXCLUDES="   제외 경로: %d개"
MSG_LIST_DETAILS_FILES_HEADER="📁 포함된 파일:"
MSG_LIST_HELP_TITLE="tarsync 백업 목록 관리"
MSG_LIST_HELP_USAGE="사용법:"
MSG_LIST_HELP_LIST_CMD="  %s list [페이지크기] [페이지번호]             # 백업 목록 표시"
MSG_LIST_HELP_LOG_CMD="  %s log <번호|백업이름>                      # 백업 메모와 로그 표시"
MSG_LIST_HELP_DELETE_CMD="  %s delete <백업이름>                        # 백업 삭제"
MSG_LIST_HELP_DETAILS_CMD="  %s details <백업이름>                       # 백업 상세 정보"
MSG_LIST_HELP_HELP_CMD="  %s help                                    # 도움말 표시"
MSG_LIST_HELP_EXAMPLES="예시:"
MSG_LIST_HELP_EXAMPLE_LIST="  %s list                                   # 전체 목록 표시"
MSG_LIST_HELP_EXAMPLE_LIST_SIZE="  %s list 5                                 # 5개씩 표시"
MSG_LIST_HELP_EXAMPLE_LOG_NUM="  %s log 7                                  # 7번 백업의 메모와 로그 표시"
MSG_LIST_HELP_EXAMPLE_LOG_NAME="  %s log 2025_08_02_PM_04_16_40            # 특정 백업의 메모와 로그 표시"
MSG_LIST_HELP_EXAMPLE_DELETE="  %s delete 2025_06_27_오후_02_28_59         # 특정 백업 삭제"
MSG_LIST_HELP_EXAMPLE_DETAILS="  %s details 2025_06_27_오후_02_28_59        # 백업 상세 정보"
MSG_LIST_UNKNOWN_COMMAND="❌ 알 수 없는 명령어: %s"
MSG_LIST_HELP_HINT="도움말을 보려면: %s help"

# 목록 모듈 추가 메시지
MSG_LIST_DELETE_NAME_REQUIRED="❌ 삭제할 백업 이름을 지정해주세요."
MSG_LIST_DELETE_NOT_EXISTS="❌ 백업이 존재하지 않습니다: %s"
MSG_LIST_DETAILS_NAME_REQUIRED="❌ 조회할 백업 이름을 지정해주세요."
MSG_LIST_DETAILS_NOT_EXISTS="❌ 백업이 존재하지 않습니다: %s"
MSG_LIST_LOG_BACKUP_NAME_REQUIRED="❌ 백업 번호 또는 이름을 지정해주세요."
MSG_LIST_LOG_USAGE="사용법: tarsync log <번호|백업이름>"
MSG_LIST_LOG_NOT_EXISTS="❌ 백업이 존재하지 않습니다: %s"

# ======================
# 공통 모듈 메시지
# ======================

MSG_COMMON_COMMAND_FAILED="❌ 명령어 실행 실패: %s"
MSG_COMMON_STORE_DIR_CREATING="📁 백업 저장소 생성 중: %s"
MSG_COMMON_BACKUP_SIZE_RECORDED="📦 백업 파일 크기가 메타데이터에 기록되었습니다: %s"
MSG_COMMON_METADATA_NOT_FOUND="❌ 메타데이터 파일을 찾을 수 없습니다: %s"
MSG_COMMON_SIZE_CALCULATING="📊 백업 크기 계산 중..."
MSG_COMMON_EXCLUDE_PATH_SIZE="  제외 경로 '%s': %s"
MSG_COMMON_EXCLUDE_PATH_DIFFERENT_FS="  제외 경로 '%s': 다른 파일시스템 또는 존재하지 않음"
MSG_COMMON_TOTAL_SIZE="  전체 크기: %s"
MSG_COMMON_FINAL_BACKUP_SIZE="  최종 백업 크기: %s"
MSG_COMMON_PROGRESS_START="🚀 %s 시작..."
MSG_COMMON_PROGRESS_COMMAND="   명령어: %s"
MSG_COMMON_PROGRESS_COMPLETE="✅ %s 완료!"
MSG_COMMON_PROGRESS_FAILED="❌ %s 실패!"
